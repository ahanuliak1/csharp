...
public class Shop
{
    ...
    public Shop()
    {
        ...
        Jedlo = new List<Jedlo>
        {
            ...
            new Jedlo("Kuracie maso", 5, 40),
            new Jedlo("Jablko", 0.5, 10)
        };
    }

    public void ZobrazKryptomeny()
    {
        Console.WriteLine("\n=== SHOP - KRYPTOMENY ==="); // zrob mi shop s kryptomenamy taky lepsi nazov 
        Console.WriteLine("(Kupit)");
